...
public class VoiceActivity extends AppCompatActivity {
     ...
     */
    private static final String TWILIO_ACCESS_TOKEN_SERVER_URL = "http://192.168.2.205:3000/accessToken";
    ...
    private RegistrationListener registrationListener(){
        return new RegistrationListener() {
            ...
            public void onError(@NonNull RegistrationException error, @NonNull String accessToken, @NonNull String fcmToken) {
                String message = String.format("Registeration Error: %d, %s", error.getErrorCode(), error.getMessage());
                Log.e(TAG, message);
...
//            getApplicationContext().registerReceiver(voiceBroadcastReceiver, intentFilter);
    ...
    public static AlertDialog createIncomingCallDialog(Context context, CallInvite callInvite,
            ...
            if (setFocus){
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
                    AudioAttributes playbackAttributes = new AudioAttributes.Builder()
                            .setUsage(AudioAttributes.USAGE_VOICE_COMMUNICATION) // USAGE_ASSISTANCE_SONIFICATION
    ...
    private void mute(){
        if (activeCall != null){
            ...
            if (mute){
                muteActionFab.setImageDrawable(ContextCompat.getDrawable(VoiceActivity.this,
                        R.drawable.ic_mic_white_off_24dp));
            } else {
                muteActionFab.setImageDrawable(ContextCompat.getDrawable(VoiceActivity.this,
